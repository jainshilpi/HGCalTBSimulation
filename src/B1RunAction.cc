...
//CreateTree::Instance() -> EnergyTotal = edep;
//float EnergyTotal = edep;
...
/*
  ...
  const ExN01PrimaryGeneratorAction* generatorAction
 ...
 /* if (IsMaster()) {
  ...
  G4cout
     ...
     << G4BestUnit(dose,"Energy") << " +- " << G4BestUnit(rmsDose,"Dose")
     << G4endl
     << "------------------------------------------------------------"
     << G4endl
     << G4endl; */
